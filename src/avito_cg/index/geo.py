...
class GeoIndex:
    ...
    def fit(
        ...
        *,
        ...
        """Восстановить центры поисковых локаций и откалибровать расстояние

        Центр локации - медиана координат объявлений, выбранных в ней по обучающим
        парам. Калибровка - гистограмма расстояний у выбранных объявлений против
        гистограммы до случайных, отношение плотностей и есть вклад расстояния
        в вероятность релевантности. Фон берётся по тем же поисковым локациям,
        что и позитивы, иначе отношение мерило бы разницу в составе локаций
        """
